...
static void sha_end1(unsigned char hval[], XANADU_CRYPTO_SHA256_CONTEXT ctx[1], const unsigned int hlen)
{
...
{
	memset(ctx, 0, sizeof(XANADU_CRYPTO_SHA256_CONTEXT));
...
{
	XANADU_CRYPTO_SHA256_CONTEXT  cx[1];
...
static void sha_end2(unsigned char hval[], XANADU_CRYPTO_SHA512_CONTEXT ctx[1], const unsigned int hlen)
{
...
{
	memset(ctx, 0, sizeof(XANADU_CRYPTO_SHA384_CONTEXT));
...
{
	XANADU_CRYPTO_SHA384_CONTEXT  cx[1];
...
{
	memset(ctx, 0, sizeof(XANADU_CRYPTO_SHA512_CONTEXT));
...
{
	XANADU_CRYPTO_SHA512_CONTEXT  cx[1];
...
XANADU_CRYPTO_EXPORT int XANADUAPI sha2_begin(unsigned long len, XANADU_CRYPTO_SHA2_CONTEXT ctx[1])
{
	switch(len)
	{
#if defined(SHA_224)
...
{
	XANADU_CRYPTO_SHA2_CONTEXT    cx[1];
